...
################################################################################
/**
 * Classe generada para a tabela "tb_social_curtir"
 * in 2012-10-02
...
class Tb_social_curtir extends Lumine_Base {

    // sobrecarga
    protected $_tablename = 'tb_social_curtir';
    ...
    protected function _initialize()
    {
        ...
        $this->_addField('tb_social_comentarios', 'ID_COMENTARIO', 'int', 50, array('primary' => true, 'notnull' => true, 'default' => '0', 'foreign' => '1', 'onUpdate' => 'RESTRICT', 'onDelete' => 'RESTRICT', 'linkOn' => 'ID_COMENTARIO', 'class' => 'Tb_social_comentarios'));
     ...
     * @author Hugo Ferreira da Silva
     * @return Tb_social_curtir
     */
    public static function staticGet($pk, $pkValue = null)
    {
        $obj = new Tb_social_curtir;
        $obj->get($pk, $pkValue);
        return $obj;
    }
