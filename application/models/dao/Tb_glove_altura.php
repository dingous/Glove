...
################################################################################
/**
 * Classe generada para a tabela "tb_glove_altura"
 * in 2013-02-06
...
class Tb_glove_altura extends Lumine_Base {

    // sobrecarga
    protected $_tablename = 'tb_glove_altura';
    ...
    protected function _initialize()
    {
        ...
        $this->_addField('ID_ALTURA', 'ID_ALTURA', 'int', 11, array('primary' => true, 'notnull' => true, 'autoincrement' => true));
        ...
        $this->_addForeignRelation('tb_glove_perfis', self::ONE_TO_MANY, 'Tb_glove_perfil', 'tb_glove_altura', null, null, null);
    }

    /**
     * Recupera um objeto estaticamente
     * @author Hugo Ferreira da Silva
     * @return Tb_glove_altura
     */
    public static function staticGet($pk, $pkValue = null)
    {
        $obj = new Tb_glove_altura;
        $obj->get($pk, $pkValue);
        return $obj;
    }
