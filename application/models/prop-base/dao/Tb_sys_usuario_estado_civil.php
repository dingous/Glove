...
require_once 'D:\wamp\www\glove\library\lumine/Lumine.php';
require_once 'D:/wamp/www/glove/application/models/lumine-conf.php';

Lumine::load('Form_White');

$cfg = new Lumine_Configuration( $lumineConfig );
$cfg->import('Tb_sys_usuario_estado_civil');
