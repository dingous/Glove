...
class _tree_struct {
	...
	// Constructor
	function __construct($table = "tb_cms_menusconteudo", $fields = array()) {
		$this->table = $table;
		if(!count($fields)) {
...
class My_Plugins_jstree_classtreeMenusConteudos extends _tree_struct { 
	function __construct($table = "tb_cms_menusconteudo", $fields = array(), $add_fields = array("title" => "title", "type" => "type")) {
