...
class _tree_struct {
	...
	// Constructor
	function __construct($table = "tb_sys_admin_menu", $fields = array()) {
		$this->table = $table;
		if(!count($fields)) {
...
class My_Plugins_jstree_classtree extends _tree_struct { 
	function __construct($table = "tb_sys_admin_menu", $fields = array(), $add_fields = array("title" => "title", "type" => "type")) {
