<?php
class My_Plugins_jstree_databasei {
	private $data		= false;
	...
	function __construct() {
		...
		$configFile = new Zend_Config_Ini($_SERVER['DOCUMENT_ROOT'].'/application/configs/application.ini', 'treeview');

		
					
		$db_config = array(
			"servername"=> $configFile->db->host,
			"username"	=> $configFile->db->user,
			"password"	=> $configFile->db->pass,
