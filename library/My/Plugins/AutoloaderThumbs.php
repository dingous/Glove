 ...
 * Clase Apiki_Layout
 */
class My_Plugins_AutoloaderThumbs implements Zend_Loader_Autoloader_Interface {
   ...
   */
   public function autoload($class) {
      $file = APPLICATION_PATH . '/../library/phpthumb-latest/' . self::$php_thumb_classes[$class];
      if (is_file($file)) {
         require_once($file);
         return $class;
      }
