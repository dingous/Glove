...
jQuery.validator.addMethod("datahota", function (value, element) {
    //contando chars
...
jQuery.validator.addMethod("selecao", function (value, element) {
    if (element.value == "none" || element.value == "0") { return false; }
    else { return true; }
}, "Selecione uma opcao");

jQuery.validator.addMethod("hierarquia", function (value, element) {
    if (element.value == "" || element.value == "false") { return false; }
    else { return true; }
}, "Selecione pelo menos uma hierarquia");