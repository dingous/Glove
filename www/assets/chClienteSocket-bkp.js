var socket = null;
var voce = null;
var url = 'http://localhost:9090/glove';
//var url = 'http://www.glovebrasil.com.br:9090';
...
$(document).ready(function() {
		...
		{	
		  ...
		  if (window.location.toString().search('.com.br') != -1) {
			  ...
			  url = 'http://www.glovebrasil.com.br:9090/glove';
			  
		  }else{
			  url = 'http://localhost:9090/glove';
			...
			socket.on('sendchat', function (data) {
				...
				if(tipo == "remetente")
				{
					...
					corpo.append("<div class='linhaMsg'><div class='avatar'><img src='/thumbs/index/w/40/h/40/type/2/autocrop/true/file/"+data.dataremetente.foto+"' title='"+data.dataremetente.nome+"' /></div> <div class='msg'> <i>" + dataHora() + "</i> - <b>" + data.dataremetente.nome + "</b> diz: <br>" + msg+"</div></div>");
			...
			/*alert("ant "+heightantes);	
			alert("depois "+heightdepois);
			alert("calc "+calcScroll);*/
